...
#'  \item{avgpower.nozeros - average cadence excluding zeros}
#'  \item{avgpower.withzeros - average cadence including zeros}
#'  \item{avgpower.postcal.rolling - average cadence excluding time before and after stops}
